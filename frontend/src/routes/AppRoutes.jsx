...
import ClientOnboarding from '@pages/client/ClientOnboarding/ClientOnboarding';
  ...
  return (
    <Routes>
      <Route element={<Layout />}>
        ...
        <Route path="admin/catalog" element={protectedRoute(<AdminCatalog />, 'ADMIN')} />
        ...
        <Route path="client/welcome" element={protectedRoute(<ClientOnboarding />, 'CLIENT')} />
